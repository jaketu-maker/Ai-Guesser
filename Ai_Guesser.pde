...
void setup() {
  ...
  AiDescriptions.put("Image 8", "Although the image appears convincing at first glance, several subtle details reveal its AI-generated origin rather than a real photograph. The hands of the man examining the herbs exhibit slightly unnatural anatomical structure and finger alignment upon close inspection. Further back in the alley, the crowd of people and architectural elements melt into ambiguous, blended shapes rather than maintaining distinct forms. Additionally, the store signage in the upper-right background displays garbled, non-existent lettering instead of legible script. Finally, the lighting across the fruit stalls has an overly smooth, painterly sheen that lacks the raw imperfections of a candid street photograph.");
  AiDescriptions.put("Image 9", "While this scenic coastal image looks remarkably real, several fine details give away its AI origins. Upon closer inspection, the fisherman's hands and the net weaving tool merge strangely with the mesh, lacking natural anatomical grip and physical depth. The bicycle parked against the wall has a warped frame and spokes that fade unnaturally into the building's shadow. In the distance, the small figures on the boat and the far shoreline feature soft, smudged features rather than distinct human forms or crisp structures. Finally, the cobblestone pavement in the foreground exhibits an overly repetitive, perfectly smoothed texture that feels digitally rendered rather than weathered by time.");
  AiDescriptions.put("Image 10", "Although this vibrant market scene appears lifelike at first glance, several subtle flaws highlight its AI origin. A close look at the woman's hands reveals awkward finger placement as she touches the tomato, lacking true anatomical precision. In the background, the small dog and nearby pedestrian appear strangely soft, with blurred features that melt unnaturally into the alleyway floor. Additionally, the small price tags placed among the fruit displays contain garbled, illegible scribbles instead of real numbers or text. Finally, the stone walls and wooden shutters exhibit a slightly uniform, hyper-smooth texture typical of digital rendering.");
  AiDescriptions.put("Image 11", "This image displays clear markers of a genuine photograph taken by a human photographer rather than a digital creation. The lighting is completely natural and consistent, showing authentic direct sun casting sharp, physically accurate shadows under the man's arm and across the concrete steps. Small, organic imperfections—like the realistic fabric creases around his mask, the faint scar on his left wrist, and the natural wear on the metal handrails—demonstrate raw real-world texture. Furthermore, the text printed on his shirt is perfectly crisp, structured, and legible, avoiding the warped or scrambled characters typical of AI rendering. Finally, both of his hands exhibit natural anatomical proportions with realistic skin folding around the phone.");
